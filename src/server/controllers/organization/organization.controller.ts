...
export class OrganizationController extends BaseController<controllerResponse> {
  ...
  async createOrganization(@request() req: Request, @response() res: Response, @requestBody() body: OrganizationDTO) {
    try {
  ...
  async getOrganizations(@request() req: Request, @response() res: Response, @queryParam() query: QueryDTO) {
    try {
  ...
  async getOrganization(@request() req: Request, @response() res: Response, @requestParam('id') id: string) {
    try {
  ...
  async deleteOrganization(@request() req: Request, @response() res: Response, @requestParam('id') id: string) {
    try {
      await Organizations.deleteOrganization(id, req);
